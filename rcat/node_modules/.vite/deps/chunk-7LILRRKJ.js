...
var DynamicTexture = class _DynamicTexture extends Texture {
   ...
   */
  constructor(name2, options, scene = null, generateMipMaps = false, samplingMode = 3, format = 5, invertY) {
...
var Layer = class _Layer {
   ...
   */
  constructor(name2, imgUrl, scene, isBackground, color, forceGLSL = false) {
    this.name = name2;
    ...
    if (this._previousDefines !== defines) {
      ...
      this._drawWrapper.effect = engine.createEffect("layer", [VertexBuffer.PositionKind], ["textureMatrix", "color", "scale", "offset"], ["textureSampler"], defines, void 0, void 0, void 0, void 0, this._shaderLanguage, this._shadersLoaded ? void 0 : async () => {
        if (this._shaderLanguage === 1) {
          await Promise.all([import("./layer.vertex-Q6V5CSR2.js"), import("./layer.fragment-AJI7CXXU.js")]);
        } else {
          await Promise.all([import("./layer.vertex-PWA5N7ZD.js"), import("./layer.fragment-OW5BZZAB.js")]);
        }
...
var AdvancedDynamicTexture = class _AdvancedDynamicTexture extends DynamicTexture {
   ...
   */
  constructor(name2, width = 0, height = 0, scene, generateMipMaps = false, samplingMode = Texture.NEAREST_SAMPLINGMODE, invertY = true) {
    super(name2, { width, height }, scene, generateMipMaps, samplingMode, Constants.TEXTUREFORMAT_RGBA, invertY);
   ...
   * @returns a new AdvancedDynamicTexture
   */
  static CreateFullscreenUI(name2, foreground = true, scene = null, sampling = Texture.BILINEAR_SAMPLINGMODE, adaptiveScaling = false) {
    const result = new _AdvancedDynamicTexture(name2, 0, 0, scene, false, sampling);
...
//# sourceMappingURL=chunk-7LILRRKJ.js.map
