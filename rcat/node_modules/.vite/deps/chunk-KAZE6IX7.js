...
var name2 = "bonesDeclaration";
var shader2 = `#if NUM_BONE_INFLUENCERS>0
...
var name3 = "bakedVertexAnimationDeclaration";
var shader3 = `#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
var name4 = "instancesDeclaration";
...
var name5 = "prePassVertexDeclaration";
...
var name6 = "samplerVertexDeclaration";
var shader6 = `#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
var name7 = "bumpVertexDeclaration";
var shader7 = `#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
...
var name10 = "lightVxFragmentDeclaration";
...
var name11 = "lightVxUboDeclaration";
...
var name12 = "morphTargetsVertexGlobalDeclaration";
var shader12 = `#ifdef MORPHTARGETS
...
var name13 = "morphTargetsVertexDeclaration";
var shader13 = `#ifdef MORPHTARGETS
...
var name14 = "morphTargetsVertexGlobal";
var shader14 = `#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
float vertexID;
#endif
#endif
...
var name15 = "morphTargetsVertex";
var shader15 = `#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
var name17 = "bonesVertex";
var shader17 = `#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
var name18 = "bakedVertexAnimation";
var shader18 = `#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
var name19 = "prePassVertex";
var shader19 = `#ifdef PREPASS_DEPTH
...
var name20 = "uvVariableDeclaration";
var shader20 = `#if !defined(UV{X}) && defined(MAINUV{X})
vec2 uv{X}=vec2(0.,0.);
#endif
#ifdef MAINUV{X}
vMainUV{X}=uv{X};
...
var name21 = "samplerVertexImplementation";
var shader21 = `#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
if (v_INFONAME_==0.)
...
var name22 = "bumpVertex";
var shader22 = `#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
...
var name23 = "clipPlaneVertex";
var shader23 = `#ifdef CLIPPLANE
...
var name25 = "shadowsVertex";
var shader25 = `#ifdef SHADOWS
...
var name26 = "vertexColorMixing";
var shader26 = `#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
vColor=vec4(1.0);
#ifdef VERTEXCOLOR
#ifdef VERTEXALPHA
vColor*=color;
...
var name28 = "decalVertexDeclaration";
var shader28 = `#ifdef DECAL
uniform vec4 vDecalInfos;uniform mat4 decalMatrix;
#endif
`;
ShaderStore.IncludesShadersStore[name28] = shader28;
//# sourceMappingURL=chunk-KAZE6IX7.js.map
